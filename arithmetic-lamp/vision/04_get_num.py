# from numpy.lib.arraypad import _validate_lengths ImportError: cannot import name '_validate_leng - ~鹏鹏在努力~ - CSDN博客 https://blog.csdn.net/u012785169/article/details/88689998
    ...
    for contour in contours:
        ...
        if len(original_img):
            ...
            if w > 50: # 两个数字连在一起的情况
                ...
                cv2.imwrite(r".\data" + '\\' + str(time.time())+'.jpg', img_save)
...
if __name__ == "__main__":
    # # filename = r"C:\Users\Administrator\Desktop\mathAI\Vision\54.jpg"
    # # filename = r"C:\Users\Administrator\Desktop\mathAI\Vision\data\1560151045.4546323.jpg"
    # # filename = r"C:\Users\Administrator\Desktop\mathAI\Vision\data\1560151014.6918726.jpg"
    # filename = r"C:\Users\Administrator\Desktop\mathAI\Vision\data\equation\1560151011.6787002.jpg"
    ...
    for filename in data_list:
        original_img, binary_img = read_img_and_convert_to_binary(path + '\\' + filename)
        symbols = binary_img_segment(binary_img, original_img=original_img)
        cv2.imshow("", original_img)
        print(symbols)
        cv2.waitKey(0)
